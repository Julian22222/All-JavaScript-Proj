...
function RPS() {
  ...
  //chousen your rock,paper,scissors
  ...
  const [showLose, setShowLose] = useState(null);
  ...
  useEffect(() => {
    ...
    // if (myPoints === 3) {
    //   setShowEndMsg("YOU WON THE GAME!!!! ,GREAT JOB!!!! ");
    // }

    // if (showOpponent === 3) {
    //   setShowEndMsg("YOU LOST THE GAME ,LET'S TRY AGAIN! ");
    // }
  }, [yourValue, showOpponent, showEndMsg, myPoints, opponentPoints]);
  ...
  return (
    <div class="all-page-rps">
      ...
      {/* <AudioPlayer src={track} onPlay={(e) => console.log(e)} /> */}
      <img
        // width={150}
        // height={100}
        src={headerPicture}
